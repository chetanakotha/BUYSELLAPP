...
import {getUser, getPurchaseRequestsBySeller, getProduct, acceptPurchaseRequest, rejectPurchaseRequest} from "../../controller/dao";
...
export default function Purchases() {
        ...
        const fetchData = async () => {
            try {
                await getUser(auth).then((user) => {
                    ...
                    getPurchaseRequestsBySeller(user.id).then((requests) => {
    ...
    const handleReject = (id) => {
        rejectPurchaseRequest(id).then(() => {
            router.replace("purchases");
        })
    }

    const handleAccept = (id) => {
        acceptPurchaseRequest(id).then(() => {
            router.replace("purchases");
        })
    }
